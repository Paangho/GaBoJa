...
class _VideoSelctor extends StatelessWidget {
  final VoidCallback onLogoTap;

  const _VideoSelctor({required this.onLogoTap, super.key});
...
class _Bottom extends StatelessWidget {
  ...
  const _Bottom({required this.position, required this.maxPosition, super.key});
